...
# https://github.com/HandBrake/HandBrake/blob/1.8.x/contrib/libdovi/A01-Expose-parse_itu_t35_dovi_metadata_obu-to-C-api.patch
Patch1:         dolby_vision-Expose-parse_itu_t35_dovi_metadata_obu-to-C-api.patch
